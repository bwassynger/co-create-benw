...
function play() {
    ...
    var planeGeometry = new THREE.PlaneGeometry(1600, 1600, 40, 40);
    ...
    var plane = new THREE.Mesh(planeGeometry, skyMaterial);
    ...
    */
    ...
    var spotLight = new THREE.SpotLight(0x87ceeb);
    ...
    var particleGeometry = new THREE.IcosahedronGeometry(.1, 0);
    ...
    for (var i=0; i<1000; i++) {
      ...
      particleMesh.position.multiplyScalar(20 + (Math.random() * 100));
    ...
    function render() {
      ...
      //group.rotation.y += upperAvgFr * .01;
      group.rotation.y += .0005
